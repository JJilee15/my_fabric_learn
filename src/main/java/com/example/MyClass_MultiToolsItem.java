...
public class MyClass_MultiToolsItem
    ...
    protected static final Map<Block, Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>>> TILLING_ACTIONS = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK, Pair.of(MyClass_MultiToolsItem::canTillFarmland_Hoe, createTillAction_Hoe(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT_PATH, Pair.of(MyClass_MultiToolsItem::canTillFarmland_Hoe,createTillAction_Hoe(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT, Pair.of(MyClass_MultiToolsItem::canTillFarmland_Hoe, createTillAction_Hoe(Blocks.FARMLAND.getDefaultState())), Blocks.COARSE_DIRT, Pair.of(MyClass_MultiToolsItem::canTillFarmland_Hoe, createTillAction_Hoe(Blocks.DIRT.getDefaultState())), Blocks.ROOTED_DIRT, Pair.of(itemUsageContext -> true, createTillAndDropAction_Hoe(Blocks.DIRT.getDefaultState(), Items.HANGING_ROOTS))));
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ActionResult result;
        result = useOnBlock_Axe(context);
        if (result != ActionResult.PASS) {
            return result;
        }
        result = useOnBlock_Shovel(context);
        if (result != ActionResult.PASS) {
            return result;
        }
        result = useOnBlock_Hoe(context);
        return result;
    }

    private ActionResult useOnBlock_Axe(ItemUsageContext context) {
        World world = context.getWorld();
        BlockPos blockPos = context.getBlockPos();
        PlayerEntity playerEntity = context.getPlayer();
        BlockState blockState = world.getBlockState(blockPos);
        Optional<BlockState> optional = this.getStrippedState_Axe(blockState);
    ...
    private Optional<BlockState> getStrippedState_Axe(BlockState state) {
    ...
    private ActionResult useOnBlock_Shovel(ItemUsageContext context) {
        World world = context.getWorld();
        BlockPos blockPos = context.getBlockPos();
        BlockState blockState = world.getBlockState(blockPos);
    ...
    private ActionResult useOnBlock_Hoe(ItemUsageContext context) {
        BlockPos blockPos;
        World world = context.getWorld();
    ...
    public static Consumer<ItemUsageContext> createTillAction_Hoe(BlockState result) {
        return context -> {
    ...
    public static Consumer<ItemUsageContext> createTillAndDropAction_Hoe(BlockState result, ItemConvertible droppedItem) {
        return context -> {
            context.getWorld().setBlockState(context.getBlockPos(), result, Block.NOTIFY_ALL | Block.REDRAW_ON_MAIN_THREAD);
            context.getWorld().emitGameEvent(GameEvent.BLOCK_CHANGE, context.getBlockPos(), GameEvent.Emitter.of(context.getPlayer(), result));
    ...
    public static boolean canTillFarmland_Hoe(ItemUsageContext context) {
